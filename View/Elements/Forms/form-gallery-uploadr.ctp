<div class="form-group">
	<div class="col-md-12 file-browser">
		<?php if(!empty($this->data['Galleryimage'])) { ?>
		<ul class="data images">
		<?php foreach($this->data['Galleryimage'] as $g) { ?>	
			<li id="file_<?php echo $g['id'];?>" class="files">
				<?php echo $this->Html->link('<span data-badge="badge_'.$g['id'].'" class="badge">X</span>', array('controller' => 'galleries', 'action' => 'removeimage', $g['id'], 'admin' => 'admin', 'plugin' => false), array('escape' => false, 'class' => 'badge-wrapper'));?>
				<?php echo $this->Resize->image('galleries/'.$g['gallery_id'].'/'.$g['file'], 200, 200, true);?>
			</li>
		<?php } ?>
		</ul>
		<?php } ?>
...
$(window).load(function() {
	...
	$('.images').sortable({ 
		update: function(e, u){ 
			$.post('".$this->Html->url(array('controller' > 'galleries', 'action' => 'sortimages', 'admin' => 'admin'))."', 
