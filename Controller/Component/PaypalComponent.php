...
class PaypalComponent extends Component {
    ...
    public function initialize(Controller $controller) {
        ...
        $this->sandboxMode = Configure::read('debug');

        $this->config = array(
            'webscr' => Configure::read('MySite.Paypal.production.webscr'),
            'endpoint' => Configure::read('MySite.Paypal.production.endpoint'),
            'password' => Configure::read('MySite.Paypal.production.password'),
            'email' => Configure::read('MySite.Paypal.production.email'),
            'signature' => Configure::read('MySite.Paypal.production.signature')
        );
        if($this->sandboxMode != 0) {
            $this->config = array(
                'webscr' => Configure::read('MySite.Paypal.development.webscr'),
                'endpoint' => Configure::read('MySite.Paypal.development.endpoint'),
                'password' => Configure::read('MySite.Paypal.development.password'),
                'email' => Configure::read('MySite.Paypal.development.email'),
                'signature' => Configure::read('MySite.Paypal.development.signature')
            );
        }
    }
    ...
    private function customerinfo() {
        ...
        return http_build_query($customerinfo);
